...
del bitext_part1, bitext_part2, bitext_part3, bitext_part4, bitext_part5, mk_sentences2, en_sentences2
gc.collect()
...
del mk_sentences1, en_sentences1
gc.collect()
...
for sentence_example in titles:
    ...
    dict[temp_sentence] = tranlated_sentence
    del ibm_part4, ibm_part5
    gc.collect()
